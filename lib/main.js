	...
	THREE.GLTF2Loader = ( function () {
		...
		GLTF2Loader.prototype = {
			...
			parse: function ( data, path, onLoad, onError ) {
				...
				if ( json.asset === undefined || json.asset.version[ 0 ] < 2 ) {
					...
					onError( new Error( 'THREE.GLTF2Loader: Unsupported asset. glTF versions >=2.0 are supported.' ) );
					return;
		...
		function GLTFBinaryExtension( data ) {
			...
			if ( this.header.magic !== BINARY_EXTENSION_HEADER_MAGIC ) {
				...
				throw new Error( 'THREE.GLTF2Loader: Legacy binary file detected. Use GLTF2Loader instead.' );
